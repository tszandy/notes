...
DESCRIPTION
     ...
     -C[num], --context[=num]
             ...
             match.  The default value of num is “2” and is equivalent to “-A
             2 -B 2”.  Note: no whitespace may be given between the option and
             its argument.
...
macOS 13.5                      March 22, 2021                      macOS 13.5
